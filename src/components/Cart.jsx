...
export default function Cart() {
  return (
    <div>
      <div className="cart-container p-5 mx-6 my-6 bg-white max-w-7xl shadow-md">
...
const CartItem = ({ product }) => {
  ...
  return (
    <div className="cart-item flex justify-between py-3 border-b border-gray-200 items-center">
      ...
      <div className="cart-details flex flex-col w-1/2">
        <h3 className="cart-name text-lg font-semibold my-1.5">{description}</h3>
      ...
      <div className="price flex flex-col justify-end px-3">
